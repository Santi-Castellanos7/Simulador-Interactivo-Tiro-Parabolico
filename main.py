...
while running:
    ...
    if punto_altura_maxima:
        ...
        # NUEVO: usamos draw_label_with_bg en lugar de draw_text para que
    ...
    if punto_alcance:
        # NUEVO: línea vertical que baja desde 30px arriba del suelo hasta el impacto
        ...
        # NUEVO: etiqueta con fondo semitransparente. Corregido "máxima" → "máximo"
        draw_label_with_bg(
            screen,
...
#     # =========================
#     screen.fill(constants.PANEL_LATERAL)
#     draw_background_sprites(screen)  # Llama al metodo para que aparezca el fondo
#
